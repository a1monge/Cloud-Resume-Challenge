...
const Projects = () => (
  <section className="mb-4">
    <h2>Projects</h2>
    <ul>
      <li><span className="project-title">Portfolio Website</span><br />
      ...
      <li><span className="project-title">Data Analytics Proof of Concept</span><br />
      ...
      <li><span className="project-title">Serverless Web Backend</span><br />
